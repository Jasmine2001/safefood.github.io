<?php
    require_once dirname(__FILE__)."/views/item/head2.php";
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">協會故事</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://127.0.0.1/safefood/sidebar.php">services</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        <h3 class="title-text" span style="font-family:Microsoft JhengHei;">點食成金救剩食</h3>
                        <h2 class="title-text text-uppercase" span style="font-family:Microsoft JhengHei;">&emsp;&emsp;食來運轉護地球</h2>
                        <h4 class="title-text text-uppercase" span style="font-family:monospace;">Hsinchu Food Tranfer &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Non-profit Organizations</h4>
                        <div class="site-buttons">
                            <div class="d-flex flex-row flex-wrap">
                                <a href="https://docs.google.com/forms/d/e/1FAIpQLSfym_d07kgPcKJXucOS0Oxr4fSpHsI4Hzd5lEJEwSUrw17N6A/viewform">
                                <button type="button" class="btn button primary-button mr-4 text-uppercase">志工招募</button>
                                </a>
                                <button type="button" class="btn button secondary-button text-uppercase">店家合作</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 banner-image">
                        <img src="./img/banner/banner-image.jpg" alt="banner-img" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 about-title">
                        ...
                        <div class="paragraph py-4 w-75">
                            <p class="para">
                                一群在地居民有感於食物的浪費，造成環境的污染與社會資源消耗的問題，而籌組的公益團體。由奧地利
                                顧孚佑(Max Gufler)老師、前新竹市市長蔡仁堅先生與清大竹蜻蜓市集志工蘇至弘先生等人帶領。致力於
                                餐桌上的正義，善用食物資源為協會宗旨，目標以肚皮搶救剩食保衛地球。
                            </p>
                            <!-- <p class="para">
                                A group of local residents felt that the waste of food caused environmental pollution 
                                and social resource consumption problems.So they organized a public welfare organization. 
                                Led by Austrian teacher Max Gufler, former Hsinchu City Mayor Mr. Cai Renjian, and National 
                                Tsing Hua University Bamboo Dragonfly Fair volunteer Mr. Su Zhihong and others. Committed 
                                to justice on the table, making good use of food resources as the purpose of the association, 
                                the goal is to save the holy food and protect the earth with the belly!
                            </p> -->
                        </div>
                        <a href="https://www.facebook.com/1721690551420012/videos/237477371052559">
                        ...
                        <div class="first-row row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/jax71423">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/Play%E9%BA%B5%E5%8C%85%E6%89%8B%E4%BD%9C%E7%83%98%E7%84%99-1137055263013800/">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/%E5%B9%B8%E7%A6%8F%E9%BA%A5%E6%96%B9kohuku%E4%B8%96%E7%95%8C%E3%81%AE%E4%B8%80%E7%B4%9A%E3%83%91%E3%83%B3-107011840773609/">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/Mypane">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/GuDao01/">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.hogwartsbakery.com/">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/%E9%87%91%E9%BA%A5%E7%94%B0%E6%89%8B%E6%84%9F%E9%BA%B5%E5%8C%85-644977775632625/">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/easygabee">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <a href="https://www.facebook.com/leloulede/">
                        ...
                        <div class="experience-area">
                            ...
                            <div class="d-flex flex-row flex-wrap call-area">
                                ...
                                <div class="call-now">
                                    ...
                                    <span class="font-roboto py-2">0975-936963</span>
                                </div>
                            </div>
                ...
                <div class="container services-list">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                <div class="sevices-img text-center py-4">
                                    <img src="./img/services/s1.jpg" alt="Services-1">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase font-roboto">烘焙房合作</h5>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                <div class="sevices-img text-center py-4">
                                    <img src="./img/services/s2.jpg" alt="Services-2">
                                </div>
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                <div class="sevices-img text-center py-4">
                                    <img src="./img/services/s3.jpg" alt="Services-3">
                                </div>
                                <div class="card-body text-center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                <div class="sevices-img text-center py-4">
                                    <img src="./img/services/s4.jpg" alt="Services-4">
                                </div>
                                <div class="card-body text-center">
                ...
                <div class="row grid">
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item latest">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">拉凡德手作烘焙房</h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item popular">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">依日烘焙</h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item popular">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">芙洛麗烘焙坊</h4>
                                <span class="text-secondary">Popular, Portfolio</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">Play波蕾麵包手作烘培</h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">霍格華茲烘焙坊</h4>
                                <span class="text-secondary">Upcoming, Portfolio</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">麥方之道烘焙</h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">房角石 咖啡</h4>
                                <span class="text-secondary">Following, Portfolio</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item following">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">幸福麥方</h4>
                                <span class="text-secondary">Following, Portfolio</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item upcoming">
                        <div class="our-project">
                            ...
                            <div class="title py-4">
                                <h4 class="text-uppercase">麥Pane</h4>
                                <span class="text-secondary">Upcoming, Portfolio</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="">
                ...
                <div class="social text-center">
                    ...
                    <a href="https://www.facebook.com/hsinchufoodtranfer/?ref=page_internal"><i class="fab fa-facebook"></i></a>
